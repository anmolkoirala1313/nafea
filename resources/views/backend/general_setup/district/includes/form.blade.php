...
<div class="row">
    <div class="col-lg-12">
        <div class="mb-3">
            {!! Form::label('state_id', 'District', ['class' => 'form-label']) !!}
            {!! Form::select('state_id', $data['states'],null,['class'=>'form-select mb-3 select2','id'=>'state_id','placeholder'=>'Select State']) !!}
        </div>
    </div>
    <div class="col-lg-12">
        <div class="mb-3">
