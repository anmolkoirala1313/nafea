<div class="row">
    <div class="col-lg-12">
        <div class="mb-3">
            ...
            {!! Form::text('passport_number', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->passport_number : null,['class'=>'form-control','id'=>'passport_number','placeholder'=>'Enter passport number']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('passport_issue_date', 'Issue Date', ['class' => 'form-label required']) !!}
            {!! Form::date('passport_issue_date', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->passport_issue_date : null,['class'=>'form-control','id'=>'contact','placeholder'=>'Enter issue date']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('passport_expiry_date', 'Expiry Date', ['class' => 'form-label']) !!}
            {!! Form::text('passport_expiry_date', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->passport_expiry_date : null,['class'=>'form-control','id'=>'passport_expiry_date','placeholder'=>'Enter expiry date','readonly']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('issue_place', 'Issue Place', ['class' => 'form-label']) !!}
            {!! Form::text('issue_place', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->issue_place : null,['class'=>'form-control','id'=>'issue_place','placeholder'=>'Enter issue place']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('state', 'State', ['class' => 'form-label']) !!}
            {!! Form::text('state', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->state : null,['class'=>'form-control','id'=>'state','placeholder'=>'Enter state']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('district', 'District', ['class' => 'form-label']) !!}
            {!! Form::text('district', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate  ? $data['row']->candidate->district : null,['class'=>'form-control','id'=>'district','placeholder'=>'Enter district']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('address', 'Address', ['class' => 'form-label']) !!}
            {!! Form::text('address', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate  ? $data['row']->candidate->address : null,['class'=>'form-control','id'=>'address','placeholder'=>'Enter address']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('father_name', 'Father Name', ['class' => 'form-label']) !!}
            {!! Form::text('father_name', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->father_name : null,['class'=>'form-control','id'=>'father_name','placeholder'=>'Enter father name']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('mother_name', 'Mother Name', ['class' => 'form-label']) !!}
            {!! Form::text('mother_name', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->mother_name : null,['class'=>'form-control','id'=>'mother_name','placeholder'=>'Enter mother name']) !!}
        </div>
    </div>
    <div class="col-lg-12">
        ...
        <div class="mb-3 mt-2">
            <div class="form-check form-check-inline form-radio-success">
                @if ($page_method == 'edit' )
                    {!! Form::radio('martial_status', 1, $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->martial_status == 1:false,['class'=>'form-check-input','id'=>'martial_status1']) !!}
                @else
            ...
            <div class="form-check form-check-inline form-radio-danger">
                @if ($page_method == 'edit' )
                    {!! Form::radio('martial_status', 0, $data['row']->user_type == 'general' && $data['row']->is_candidate  ? $data['row']->candidate->martial_status == 0:true,['class'=>'form-check-input','id'=>'martial_status2']) !!}
                @else
    ...
    <div class="col-lg-12 martial-status-result">
        <div class="mb-3">
            ...
            {!! Form::text('wife_name', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->wife_name : null,['class'=>'form-control','id'=>'wife_name','placeholder'=>'Enter Wife Name']) !!}
        </div>
    </div>
    <div class="col-lg-12 martial-status-result">
        <div class="mb-3">
            {!! Form::label('children_name', 'Children Name', ['class' => 'form-label']) !!}
            {!! Form::textarea('children_name', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->children_name : null,['class'=>'form-control','id'=>'children_name','placeholder'=>'Enter Children Names']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('applied_country', 'Applied Country', ['class' => 'form-label']) !!}
            {!! Form::select('applied_country', $data['country'], $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->applied_country : null,['class'=>'form-select mb-3 select2 width-100','id'=>'applied_country','placeholder'=>'Select country']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            {!! Form::label('applied_for', 'Applied For (Job)', ['class' => 'form-label']) !!}
            {!! Form::text('applied_for', $page_method == 'edit' && $data['row']->user_type == 'general' && $data['row']->is_candidate ? $data['row']->candidate->applied_for : null,['class'=>'form-control','id'=>'applied_for','placeholder'=>'Enter applied for']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-4">
