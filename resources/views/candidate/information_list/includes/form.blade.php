...
<div class="row">
    <div class="col-lg-12">
        <div class="mb-3">
            ...
            {!! Form::select('authorized_agency_id', $data['authorized_agencies'], $page_method == 'edit' ? $data['row']->authorized_agency_id : (auth()->user()->authorized_agency_id ?? null),['class'=>'form-select mb-3','id'=>'authorized_agency_id','disabled'=>'disabled','placeholder'=>'Select authorized agency']) !!}
        </div>
    </div>
    <div class="col-lg-4">
        <div class="mb-3">
...
{{--    </div>--}}
    ...
    <div class="col-lg-12">
        <div class="mb-3 editor">
            {!! Form::label('grievance', 'Grievance Message', ['class' => 'form-label']) !!}
            {!! Form::textarea('grievance', null,['class'=>'form-control','id'=>'grievance','placeholder'=>'Enter message']) !!}
        </div>
    </div>
