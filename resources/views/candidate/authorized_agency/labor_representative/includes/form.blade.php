...
<div class="row">
    <div class="col-lg-12">
        <div class="mb-3">
            ...
            {!! Form::select('authorized_agency', $data['agencies'], auth()->user()->authorizedAgency->id,['class'=>'form-select mb-3','id'=>'authorized_agency','disabled']) !!}
            {!! Form::hidden('authorized_agency_id', auth()->user()->authorizedAgency->id,['class'=>'form-control','id'=>'authorized_agency_id']) !!}
        </div>
    </div>
    <div class="col-lg-12">
        <div class="mb-3">
