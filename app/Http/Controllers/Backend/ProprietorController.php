...
class ProprietorController extends BackendBaseController
{
    ...
    protected string $base_route    = 'backend.authorized_agency.proprietor.';
    protected string $view_path     = 'backend.authorized_agency.proprietor.';
    ...
    public function store(ProprietorRequest $request)
    {
        ...
        return response()->json(route($this->module.'authorized_agency.show', $proprietor->authorized_agency_id));
    }
