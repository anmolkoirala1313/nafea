...
class AuthorizedAgency extends BackendBaseModel
{
    ...
    protected $fillable = ['id','order','permission_number','membership_number','title','website','description','address','contact_number','email','promoter_email','promoter_phone','promoter_name','fax','image','status','created_by','updated_by'];
